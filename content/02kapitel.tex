...
%% Clusters, GPUs/TPUs, cloud computing, IaaS (SimGrid IaaS paper can illustrate system-level concerns).
%% Topologies
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.8\textwidth]{figures/astra_architecture.png}
%     \caption{ASTRA-sim architecture overview}
% \end{figure}
