...
% Von Anouk hinzugefügt, funktioniert evtl nicht
...
\usepackage{lscape}
\usepackage{listings}
\usepackage{caption} % NOTE from Anouk
\usepackage{rotating}
\usepackage{colortbl}
...
\definecolor{anoukspink}{HTML}{ffdef5}
...
\usepackage[obeyFinal,backgroundcolor=anoukspink,linecolor=black]{todonotes}  % NOTE changed
